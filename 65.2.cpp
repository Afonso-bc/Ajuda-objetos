...
#include<stdlib.h>
    ...
    void Identificacao(); //prototipo de subprograma
    void AreaRetang();  //prototipo de subprograma
    void digitdec();  //prototipo de subprograma
    void mult4();   //prototipo de subprograma
    void menu();  //prototipo de subprograma
    void saida(); //prototipo de subprograma
